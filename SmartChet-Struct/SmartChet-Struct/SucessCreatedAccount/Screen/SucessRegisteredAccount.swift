...
protocol SucessRegisteredProtocol: AnyObject{
    
    func tapToLogin()
}

class SucessRegisteredAccount: UIView {
    
    private weak var delegate: SucessRegisteredProtocol?
    
    func delegate(delegate: SucessRegisteredProtocol?){
    ...
    let imagem = UIImageView()
      imagem.translatesAutoresizingMaskIntoConstraints = false
        imagem.image = UIImage(named: "logo 1.png")
...
//    }
    ...
    func addConstraintsForElements(){
        NSLayoutConstraint.activate([
            ...
            goToLogin.bottomAnchor.constraint(equalTo: self.bottomAnchor,constant: -60),
